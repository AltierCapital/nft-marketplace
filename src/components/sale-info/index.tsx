...
import styles from "./sale-info.module.css";
...
export const SaleInfo = ({ nft }: Props) => {
  ...
  return (
    <>
      ...
      <div className={styles.saleInfoContainer} style={{ marginTop: -42 }}>
        ...
        ${tab === "direct" ? tabsStyles.activeTab : ""}`}
            onKeyDown={() => setTab("direct")}
          ...
          <h3
            className={`${tabsStyles.tab}
        ${tab === "auction" ? tabsStyles.activeTab : ""}`}
            onKeyDown={() => setTab("auction")}
        ...
        <div
          className={`${
            tab === "direct" ? styles.activeTabContent : tabsStyles.tabContent
          }`}
        ...
        <div
          className={`${
            tab === "auction" ? styles.activeTabContent : tabsStyles.tabContent
          }`}
          style={{ flexDirection: "column" }}
        >
          <h4 className={styles.formSectionTitle}>When </h4>
